...
TARGET_EXCLUDE_PIXEL_SEPOLICY := true
...
BOARD_DTBOIMAGE_PARTITION_SIZE := $(BOARD_DTBOIMG_PARTITION_SIZE)
...
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := vendor/aospa/security/avb_key.pem
